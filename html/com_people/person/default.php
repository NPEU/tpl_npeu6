            ...
            <div class="l-layout  l-gallery-grid  l-gallery-grid--gutter--s  l-gallery-grid--basis-15  l-gallery-grid--equal-rows">
                <p class="l-layout__inner" role="list">
                    <?php
                        ...
                        $image_path       = $public_root_path . trim($png_path, '/');
                        #echo '<pre>'; var_dump($image_path); echo '</pre>'; exit;
                    ?>
                    <span class="l-box  l-box--center" role="listitem">
                        <a href="/<?php echo $brand->alias; ?>" class="c-badge  c-badge--decorated  c-badge--limit-height--xl  u-block-center" style="color: <?php echo $colour; ?>;">
                            ...
                            <?php else: ?>
                            <b data-fs-text="larger"><?php echo $brand->name; ?></b>
                            <?php endif; ?>
                        </a>
                    </span>
