...
<div class="u-fill-height  mod_map  user-content">
    <figure class="l-layout  l-row  l-gutter  l-flush-edge-gutter">
        <div class="l-layout__inner">
            <div class="l-box  ff-width-100--50--50">
            ...
            <div class="l-box  ff-width-100--50--50">
                <?php if (!empty($legend)): ?>
                <figcaption class="u-space--above u-text-align--left">
                    <?php echo $legend; ?>
                </figcaption>
                <?php endif; ?>
            </div>
