...
<form action="<?php echo JRoute::_('index.php?option=com_users&task=remind.remind'); ?>" method="post">
    ...
    <div id="fieldset<?php echo $i; ?>">
        ...
        <div class="l-layout  l-row">
            <div class="l-layout__inner">
                ...
                <?php else: ?>
                <div class="l-box  u-padding--right <?php echo $field->type == 'Editor' ? 'u-fill-width' : 'ff-width-100--25--25'?>">
    ...
    <div class="l-layout  l-row">
        <div class="l-layout__inner">
            <div class="l-box  u-padding--right  ff-width-100--25--25">
            </div>
