...
<head>
    ...
    <link rel="apple-touch-icon" href="{{ project_base_url }}/apple-touch-icon.png">
...
<body role="document" class="tb-baselineX tb-outlinesX  Xd-background--very-dark  Xt-neutral"<?php /* data-layout="{{ page.layout_name }}*/ ?>">
