                        ...
                        <div class="l-primary-content<?php if ($page_has_pull_outs) : ?>  l-primary-content--has-pull-outs<?php endif; ?><?php if (!($page_has_sidebar_super || $page_has_sidebar_top || $page_has_priority_content || $page_toc)) : ?>  l-primary-content--has-pull-outs--only-bottom<?php endif; ?>  n--page-not-landing  d-background--white">
                            ...
                            <div class="l-primary-content__main<?php if ($page_has_article) : ?>  has-longform-content<?php endif; ?><?php if ($is_blog && $page_has_article) : ?>  c-panel  c-panel--rounded  d-background--very-light  t-neutral<?php endif; ?>">
                                ...
                                <div class="longform-content  user-content">
                                    ...
                                    <?php if ($is_blog && ((!empty($doc->article->publish_up) && $menu_item_params->get('show_publish_date', true) == true) || !empty($doc->article->x_url))) : ?>
                                    <p class="l-layout  l-row  l-row--push-apart  l-gutter--s  l-flush-edge-gutter">
                                        ...
                                        <?php if (!empty($doc->article->x_url)) : ?><span class="l-box"><a href="<?php echo $doc->article->x_url; ?>" class="c-cta" target="_blank"><svg focusable="false" aria-hidden="true" width="1.25em" height="1.25em" display="none"><use xlink:href="#icon-x"></use></svg> <span>Post</span></a></span><?php endif; ?>
                                        </span>
                                    </p>
                                    <?php endif; ?>
