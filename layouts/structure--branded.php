        ...
        <header class="c-page-header  t-<?php echo $page_brand->alias; ?>" aria-label="Page">
            ...
            <div class="u-text-group  u-text-group--push-apart  u-padding--sides--s">
                ...
                <p class="c-utilitext  no-print">
                    ...
                    <a href="/user-profile"><span><strong><?php echo $user->username; ?></strong></span></a> (<a href="/logout<?php /*echo '?' . JSession::getFormToken(); ?>=1&amp;return=<?php echo base64_encode('/login?logged-out'); */?>"><span>logout</span></a>)<?php if(!$user->get('staff')): ?> | <a href="/administrator"><span>Admin</span></a><?php endif; ?>
                    <?php else: ?>
                        ...
                        <div class="l-primary-content<?php if ($page_has_pull_outs) : ?>  l-primary-content--has-pull-outs<?php endif; ?>">
                            ...
                            <div class="l-primary-content__header">
                                ...
                                <div class="c-panel">
                                    ...
                                    <?php 
                                    if (isset($doc->header_cta)) {
                                        var_dump($doc->header_cta);
                                    ...
                                    <header class="u-text-group  u-text-group--push-apart  u-space--below">
                                        <h2 id="frosttie-updates">FROSTTIE updates</h2>
                                        <p><a href="https://dev.npeu.ox.ac.uk/frosttie/whats-new" class="c-cta  c-cta--has-icon">See all updates<svg display="none" class="icon" aria-hidden="true"><use xlink:href="#icon-chevron-right"></use></svg></a></p>
                                    </header>
                                    */ ?>
